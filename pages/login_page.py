...
#It is designed Page Object Model(POM) pattern.
#Which helps to keep locators and actions separates from the test logics.
...
class LoginPage:
    ...
    def __init__(self,page:Page):
        """Constructor that initializes the Playwright Page instance and defines all locators used on the Login Page."""
        self.page = page
    ...
    #======Action Methods =====
    #These methods represents user interactions on the Login Page.
